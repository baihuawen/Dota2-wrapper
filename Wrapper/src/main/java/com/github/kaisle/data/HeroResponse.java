...
public class HeroResponse {
	...
	public HeroResponse(String id, String name, String displayName,
			String smallPicURL, String mediumPicURL,
			String largeHorizontalPicURL, String largeVerticalPicURL) {
		super();
		this.id = id;
		this.name = name;
	...
	public String toString() {
		return "HeroResponse [id=" + id + ", name=" + name + ", displayName="
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		HeroResponse other = (HeroResponse) obj;
		if (displayName == null) {

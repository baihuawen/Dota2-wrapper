...
public class Inventory {
	...
	public Inventory(int item_0, int item_1, int item_2, int item_3,
			int item_4, int item_5) {
		super();
		this.item_0 = item_0;
		this.item_1 = item_1;
		this.item_2 = item_2;
	...
	public String toString() {
		return "Inventory [item_0=" + item_0 + ", item_1=" + item_1
				+ ", item_2=" + item_2 + ", item_3=" + item_3 + ", item_4="
				+ item_4 + ", item_5=" + item_5 + "]";
	}
